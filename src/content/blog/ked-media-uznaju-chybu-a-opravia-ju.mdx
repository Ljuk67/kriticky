...
import smeImg from '../../assets/sme_priznanie_chyby.webp?url';
import guardianImg from '../../assets/theguardian_video_editing.webp?url';
...
<img src={smeImg} width="300" alt="Sme.sk – priznanie chyby a oprava článku" class="mx-auto block"/>
...
<img src={guardianImg} width="600" alt="Chybne zostrihané video – príklad z Guardianu" class="mx-auto block"/>
